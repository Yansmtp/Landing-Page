    ...
    <AnimatedSection className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="relative p-8 md:p-12 rounded-3xl glass-card hover-lift mb-8"
        >
          {/* Quote icon with gradient */}
          <div className="absolute top-8 right-8 w-16 h-16 bg-gradient-to-br from-primary/20 to-purple-500/20 rounded-full flex items-center justify-center">
            <Quote className="w-8 h-8 text-primary/50" />
          </div>

          <div className="relative z-10">
            <blockquote className="text-2xl md:text-3xl lg:text-4xl font-light leading-relaxed mb-8 text-foreground">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted">Ingeniero de Software</p>
                  <p className="text-sm text-primary">Latinoamérica → EE.UU. ✅</p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-start sm:items-end gap-2">
                ...
                <p className="text-sm text-muted">Verificado • Hace 2 semanas</p>
              </div>
            </div>
          </div>
